...
Robotics & control - Microcontrollers (arduino/STM32, Raspberry Pi, ESP32) & PLC
Design & simulation - Solidworks, CAD modelling, Matlab
Tools & OS  - Git, Github, Linux (Ubuntu)
...
<!--
**rhasaraperera-arch/rhasaraperera-arch** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
